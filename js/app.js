...
import { initAuth, login, logout, getCurrentUser, getCurrentRole } from "./auth.js?v=2";
import { createUser, getAllUsers, updateUserRole, deleteUser } from "./users.js?v=2";
import { createDemande, getDemandes, updateStatut, repondreDemande, deleteDemande } from "./demandes.js?v=2";
import { showToast, showConfirm, formatDate, escapeHtml, getRoleLabel, getStatutLabel, getTypeLabel } from "./ui.js?v=2";
import { ROLES } from "./config.js?v=2";
